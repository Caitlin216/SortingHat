...
module.exports.run = async (bot, message, args) => {
    ...
    .addField("**Add Role**", "`!roleplayer` get the Roleplayer role and see the roleplay channels, `!artist` get the Artist role, `!dj`get the DJ role, `!oc1` get the Character #1 role, `!oc2` get the Character #2 role, `!oc3` get the Character #3 role, `!oc4` get the Character #4 role.")
