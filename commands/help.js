...
module.exports.run = async (bot, message, args) => {
    ...
    .addField("Admin commands", "!prefix <desired prefix>, !addrole @username <role>, !removerole @username <role>, !tempmute @username <time in s or d>, ! warn @username <reason>, ! warnlevel @username, !kick @username <reason>, !ban @username <reason>, !clear <amount msg>, !say <sentence>", true)
